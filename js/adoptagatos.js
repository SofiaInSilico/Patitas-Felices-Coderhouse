...
enAdopcion.push(new Animal(10, "Michi", "Hembra", 10, "../images/gato1.jpg"));
enAdopcion.push(new Animal(11, "Milú", "Hembra", 1, "../images/gatobebe2.jpg"));
enAdopcion.push(new Animal(12, "Pelusa", "Hembra", 15, "../images/gato5.jpg"));
enAdopcion.push(new Animal(13, "Chuli", "Macho", 33, "../images/gato3.jpg"));
enAdopcion.push(new Animal(14, "Indira", "Hembra", 64, "../images/gato6.jpg"));
enAdopcion.push(new Animal(15, "Chabón", "Macho", 46, "../images/gato2.jpeg"));
enAdopcion.push(new Animal(16, "Kiki", "Macho", 1, "../images/gato7.jpg"));


let divEnAdop = document.getElementById("gatosAdopcion");
